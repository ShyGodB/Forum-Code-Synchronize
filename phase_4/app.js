...
const boardAdminRouter = require('./routes/boards');
const topicAdminRouter = require('./routes/topics');
const showTopicRouter = require('./routes/show_topics');
...
app.use(boardAdminRouter.routes()).use(boardAdminRouter.allowedMethods());
app.use(topicAdminRouter.routes()).use(topicAdminRouter.allowedMethods());
